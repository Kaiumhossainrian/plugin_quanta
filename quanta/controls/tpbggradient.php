...
class Group_Control_TPBGGradient extends Group_Control_Base {
    ...
    public function init_fields() {
        ...
        $fields['color_type'] = [
            ...
            'description' => _x( 'Gradient color not work editor mode. If you set gradient color please view the result live preview page.', 'Background Control', 'quanta' ),
            'type' => Controls_Manager::CHOOSE,
            'label_block' => false,
            'render_type' => 'ui',
            'options' => [
                'classic' => [
                    'title' => _x( 'Solid', 'Color Control', 'quanta' ),
                    'icon' => 'eicon-paint-brush',
                ],
                'gradient' => [
                    'title' => _x( 'Gradient', 'Color Control', 'quanta' ),
                    'icon' => 'eicon-barcode',
                ],
            ],
            'default' => 'classic'
        ...
        $fields['color'] = [
            ...
            'default' => '',
            'title' => _x( 'Start Color', 'Background Control', 'quanta' ),
            'selectors' => [
        ...
        $fields['color_b'] = [
            'label' => _x( 'Second Color', 'Background Control', 'quanta' ),
            'type' => Controls_Manager::COLOR,
            'default' => '#f2295b',
            'render_type' => 'ui',
            'condition' => [

...
Class QUANTA_Popular_Post_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('quanta-popular-posts', 'Quanta Popular Posts', array(
...
add_action('widgets_init', function(){
	register_widget('QUANTA_Popular_Post_Widget');
});

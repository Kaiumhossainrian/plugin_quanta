    ...
    public function import_files_config() {
		...
		$home_prevs = array(
			'tp_demo_home_1' => array(
				'title' => __( 'Home 1', 'quanta' ),
				'page'  => __( 'home', 'quanta' ),
				'screenshot' => plugins_url( 'assets/img/demo/home01.jpg', dirname(__FILE__) ),
				'preview_link' => 'https://line.wprealizer.com/',
			),
			'tp_demo_home_2' => array(
				'title' => __( 'Home 2', 'quanta' ),
				'page'  => __( 'home-02', 'quanta' ),
				'screenshot' => plugins_url( 'assets/img/demo/home02.jpg', dirname(__FILE__) ),
				'preview_link' => 'https://line.wprealizer.com/home-02/',
			),
            'tp_demo_home_3' => array(
                'title' => __( 'Home 3', 'quanta' ),
                'page'  => __( 'home-03', 'quanta' ),
                'screenshot' => plugins_url( 'assets/img/demo/home03.jpg', dirname(__FILE__) ),
                'preview_link' => 'https://line.wprealizer.com/home-03/',
            ),
		);
        ...
        foreach ( $home_prevs as $key => $prev ) {
            ...
            $config[] = [
                ...
                'import_notice'                => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'quanta' ),
            ];
        }

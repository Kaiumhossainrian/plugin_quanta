...
class TP_Categories extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'tp_categories',
            [
                'label' => esc_html__('Category List', 'quanta'),
        ...
        $this->add_control(
            'tp_course_link',
            [
                'label' => esc_html__('More Button Link', 'quanta'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('#', 'quanta'),
                'placeholder' => esc_html__('Course Link', 'quanta'),
                'label_block' => true,
            ]
        );
                              ...
                              <div class="category__item text-center mb-45">
                                 ...
                                 <div class="category__content">
                                    <h4 class="category__title add">
                                       <a href="<?php echo esc_url($settings['tp_course_link']); ?>"><?php echo esc_html__('All Course','quanta'); ?></a>
                                    </h4>
                                 </div>
                              </div>
                           </div>

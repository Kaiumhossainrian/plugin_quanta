...
class TP_Live_Donation extends Widget_Base {
	...
	public function get_title() {
		return __( 'Live Donation', 'quanta' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Percentage', 'quanta'),
                'description' => tp_get_allowed_html_desc( 'basic' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('80', 'quanta'),
                'placeholder' => esc_html__('Type Percentage Number', 'quanta'),
                'label_block' => true,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'tp_donate_number',
            [
                'label' => esc_html__('Donation Number', 'quanta'),
                'description' => tp_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('28,0000', 'quanta'),
                'placeholder' => esc_html__('Type donation number here', 'quanta'),
            ]
        );

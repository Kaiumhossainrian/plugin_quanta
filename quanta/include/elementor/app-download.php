	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Google play', 'quanta'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Button 2', 'quanta'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Button Text', 'quanta'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Apple store', 'quanta'),
                'title' => esc_html__('Enter button text', 'quanta'),
                'label_block' => true,
                'condition' => [
        ...
        $this->add_control(
            'tp_image_2',
            [
                'label' => esc_html__( 'Choose BG Image', 'quanta' ),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
                    'url' => \Elementor\Utils::get_placeholder_image_src(),
                ],

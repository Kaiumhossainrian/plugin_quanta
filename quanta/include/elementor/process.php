...
class TP_Process extends Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'tp_process',
            [
                'label' => esc_html__('Process List', 'quanta'),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Upload White Icon Image', 'quanta'),
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => Utils::get_placeholder_image_src(),
                ],
        ...
        $repeater->add_control(
            'tp_process_step', [
                ...
                'default' => esc_html__('Step - 01', 'quanta'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'tp_process_title' => esc_html__('Discover', 'quanta'),
                    ],
                    [
                        'tp_process_title' => esc_html__('Define', 'quanta')
                    ],
                    [
                        'tp_process_title' => esc_html__('Develop', 'quanta')
                    ],
                    [
                        'tp_process_title' => esc_html__('Deliver', 'quanta')
                    ]
                ],

...
class TP_Campaign extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'tp_campaign_query',
            [
                'label' => esc_html__('Campaign Query', 'quanta'),
            ]
        );
        ...
        $this->start_controls_section(
            'tp_campaign',
            [
                'label' => esc_html__('Campaign - Layout', 'quanta'),
            ]
        );
        $this->add_control(
            'tp_design_style',
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Default with Pagination', 'quanta'),
                    'layout-2' => esc_html__('Slider Donation', 'quanta'),
                    'layout-3' => esc_html__('Tab Donation', 'quanta'),
                    'layout-4' => esc_html__('Live Donation', 'quanta'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->start_controls_section(
            'tp_campaign_columns_section',
            [
                'label' => esc_html__('Campaign - Columns', 'quanta'),
            ]
        );
		...
		$this->start_controls_section(
            'tp_campaign_slider_columns_section',
            [
                'label' => esc_html__('Campaign - Columns for Carousel', 'quanta'),
            ]
        );
                    ...
                    <div class="featureBlock__donation">
                      ...
                      <div class="featureBlock__eqn">
                        <div class="featureBlock__eqn__block">
                          <span class="featureBlock__eqn__title"><?php echo esc_html__('our goal','quanta'); ?></span>
                          <span class="featureBlock__eqn__price"><?php echo $campaign_goal; ?></span>
                        </div>
                        <div class="featureBlock__eqn__block">
                          <span class="featureBlock__eqn__title"><?php echo esc_html__('Raised','quanta'); ?></span>
                          <span class="featureBlock__eqn__price"><?php echo $campaign_donated_amount; ?></span>
                        </div>
                        <div class="featureBlock__eqn__block">
                          <span class="featureBlock__eqn__title"><?php echo esc_html__('to go','quanta'); ?></span>

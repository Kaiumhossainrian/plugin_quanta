...
$this->start_controls_section(
            '_section_gallery',
            [
                'label' => esc_html__( 'Gallery - Content', 'quanta' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__( 'Type gallery title', 'quanta' ),
                'default' => esc_html__( 'Gallery Title', 'quanta' ),
            ]
        );        
        $repeater->add_control(
            'description',
            [
                ...
                'placeholder' => esc_html__( 'Type description here', 'quanta' ),
                'default' => esc_html__( 'If you are going to use a passage of Lorem Ipsum, you need to be sure there is anything embarrassing hidden in the middle of text', 'quanta' ),
            ]
        );
        $repeater->add_control(
            'filter',
            [
                'label' => esc_html__( 'Filter Name (Category)', 'quanta' ),
                'type' => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Type gallery filter name', 'quanta' ),
                'description' => esc_html__( 'Filter name will be used in filter menu. Added more category by , separator.', 'quanta' ),
                'default' => esc_html__( 'Filter Name', 'quanta' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'show_label' => false,
                'title_field' => sprintf( esc_html__( 'Filter Group: %1$s', 'quanta' ), '{{filter}}' ),
                'default' => [
                    [
                        'images' => Utils::get_placeholder_image_src(),
                        'filter' => esc_html__( 'Web Design', 'quanta' ),
                        'title' => esc_html__( 'Ecommerce Product Apps', 'quanta' ),

                    ],
                    [
                        'images' => Utils::get_placeholder_image_src(),
                        'filter' => esc_html__( 'Logo Design', 'quanta' ),
                        'title' => esc_html__( 'Cryptocurrency web Application', 'quanta' ),

                    ],
                    [
                        'images' => Utils::get_placeholder_image_src(),
                        'filter' => esc_html__( 'Mobile App', 'quanta' ),
                        'title' => esc_html__( 'Making 3d Illustration', 'quanta' ),

                    ],
                    [
                        'images' => Utils::get_placeholder_image_src(),
                        'filter' => esc_html__( 'Ui/Kit', 'quanta' ),
                        'title' => esc_html__( 'Hilon - Personal Portfolio', 'quanta' ),
        ...
        $this->add_control(
            'show_filter',
            [
                'label' => esc_html__( 'Show Filter', 'quanta' ),
        ...
        $this->add_control(
            'show_all_filter',
            [
                'label' => esc_html__( 'Show "All Project" Filter?', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'quanta' ),
                'label_off' => esc_html__( 'No', 'quanta' ),
                'return_value' => 'yes',
                'default' => 'yes',
                'description' => esc_html__( 'Enable to display "All Project" filter in filter menu.', 'quanta' ),
                'condition' => [
                    'show_filter' => 'yes'
                ],
                'style_transfer' => true,
        ...
        $this->add_control(
            'all_filter_label',
            [
                'label' => esc_html__( 'Filter Label', 'quanta' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'All Project', 'quanta' ),
                'placeholder' => esc_html__( 'Type filter label', 'quanta' ),
                'description' => esc_html__( 'Type "All Project" filter label.', 'quanta' ),
                'condition' => [
                    'show_all_filter' => 'yes',
                    'show_filter' => 'yes'
                ]

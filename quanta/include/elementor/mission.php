...
// layout Panel
        ...
        $this->add_control(
            'tp_video_url',
            [
                'label' => esc_html__('Video URL', 'quanta'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('#', 'quanta'),
                'placeholder' => esc_html__('Video url here.', 'quanta'),
            ]
        );
        ...
        $repeater->add_control(
            'tp_service_title', [
                ...
                'default' => esc_html__('1600', 'quanta'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'tp_service_title' => esc_html__('1600', 'quanta'),
                    ],
                    [
                        'tp_service_title' => esc_html__('289', 'quanta')
                    ],
                    [
                        'tp_service_title' => esc_html__('16k', 'quanta')
                    ],
                    [
                        'tp_service_title' => esc_html__('24mln', 'quanta')
                    ]
                ],

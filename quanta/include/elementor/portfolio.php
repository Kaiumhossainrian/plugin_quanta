	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'tp_portfolio_title' => esc_html__('Business Stratagy', 'quanta'),
                    ],
                    [
                        'tp_portfolio_title' => esc_html__('Website Development', 'quanta')
                    ],
                    [
                        'tp_portfolio_title' => esc_html__('Marketing & Reporting', 'quanta')
                    ],
                    [
                        'tp_portfolio_title' => esc_html__('Mobile Development', 'quanta')
                    ],
                    [
                        'tp_portfolio_title' => esc_html__('Marketing & Reporting', 'quanta')
                    ],

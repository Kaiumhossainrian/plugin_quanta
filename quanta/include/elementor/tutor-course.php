...
class TP_Tutor_Course extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'tp_tutor_query',
            [
                'label' => esc_html__('Tutor Query', 'quanta'),
            ]
        );
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => esc_html__('Posts Per Page', 'quanta'),
                'description' => esc_html__('Leave blank or enter -1 for all.', 'quanta'),
        ...
        $this->add_control(
            'category',
            [
                'label' => esc_html__('Include Categories', 'quanta'),
                'description' => esc_html__('Select a category to include or leave blank for all.', 'quanta'),
        ...
        $this->add_control(
            'exclude_category',
            [
                'label' => esc_html__('Exclude Categories', 'quanta'),
                'description' => esc_html__('Select a category to exclude', 'quanta'),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
                'options' => tp_get_categories($taxonomy),
                'label_block' => true
        ...
        $this->add_control(
            'post__not_in',
            [
                'label' => esc_html__('Exclude Item', 'quanta'),
                'type' => Controls_Manager::SELECT2,
        ...
        $this->add_control(
            'offset',
            [
                'label' => esc_html__('Offset', 'quanta'),
                'type' => Controls_Manager::NUMBER,
                'default' => '0',
            ]
        );
        ...
        $this->add_control(
            'orderby',
            [
                'label' => esc_html__('Order By', 'quanta'),
        ...
        $this->add_control(
            'order',
            [
                'label' => esc_html__('Order', 'quanta'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'asc' 	=> esc_html__( 'Ascending', 'quanta' ),
                    'desc' 	=> esc_html__( 'Descending', 'quanta' )
                ],
                'default' => 'desc',
        ...
        $this->add_control(
            'ignore_sticky_posts',
            [
                'label' => esc_html__( 'Ignore Sticky Posts', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'content',
            [
                'label' => __('Content', 'quanta'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'quanta'),
                'label_off' => __('Hide', 'quanta'),
                'return_value' => 'yes',
                'default' => '',
            ]
        );
        ...
        $this->start_controls_section(
            'tp_campaign',
            [
                'label' => esc_html__('Tutor - Layout', 'quanta'),
            ]
        );
        $this->add_control(
            'tp_design_style',
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Grid Style 1', 'quanta'),
                    'layout-2' => esc_html__('Grid Style 2', 'quanta'),
                    'layout-3' => esc_html__('Grid Style 3', 'quanta'),
                    'layout-4' => esc_html__('Grid Style 4', 'quanta'),
                ],
                'default' => 'layout-1',
            ]
        );
        $this->add_control(
            'tp_tutor_height',
            [
                'label' => esc_html__( 'Height', 'quanta' ),
        ...
        $this->add_control(
            'tp_tutor_arrow',
            [
                'label' => esc_html__('Arrow Icons?', 'quanta'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'quanta'),
                'label_off' => esc_html__('Hide', 'quanta'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_tutor_infinite',
            [
                'label' => esc_html__('Infinite?', 'quanta'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'quanta'),
                'label_off' => esc_html__('No', 'quanta'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_tutor_autoplay',
            [
                'label' => esc_html__('Autoplay?', 'quanta'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'quanta'),
                'label_off' => esc_html__('No', 'quanta'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Autoplay Speed', 'quanta'),
                'type' => Controls_Manager::TEXT,
                'default' => '2500',
                'title' => esc_html__('Enter autoplay speed', 'quanta'),
                'label_block' => true,
                'condition' => array(
        ...
        $this->add_control(
            'tp_tutor_filter',
            [
                'label' => esc_html__('Filter?', 'quanta'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'quanta'),
                'label_off' => esc_html__('No', 'quanta'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_tutor_pagination',
            [
                'label' => esc_html__( 'Pagination', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_image_show',
            [
                'label' => esc_html__( 'Show Image', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_prcie_show',
            [
                'label' => esc_html__( 'Show Price', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_cat_show',
            [
                'label' => esc_html__( 'Show Category', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_author_show',
            [
                'label' => esc_html__( 'Show Author', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_lessons_show',
            [
                'label' => esc_html__( 'Show Lessons', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_duration_show',
            [
                'label' => esc_html__( 'Show Duration', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_rating_show',
            [
                'label' => esc_html__( 'Show Rating', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'tp_students_show',
            [
                'label' => esc_html__( 'Show Students', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show difficulty', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show wishlist', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->start_controls_section(
            'tp_tutor_columns_section',
            [
                'label' => esc_html__('Tutor - Columns', 'quanta'),
            ]
        );
		...
		$this->start_controls_section(
            'tp_tutor_slider_columns_section',
            [
                'label' => esc_html__('Tutor - Columns for Carousel', 'quanta'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Extra Large Desktop', 'quanta' ),
                'description' => esc_html__( 'Screen width equal to or greater than 1920px', 'quanta' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'quanta' ),
                    2 => esc_html__( '2 Columns', 'quanta' ),
                    3 => esc_html__( '3 Columns', 'quanta' ),
                    4 => esc_html__( '4 Columns', 'quanta' ),
                    5 => esc_html__( '5 Columns', 'quanta' ),
                    6 => esc_html__( '6 Columns', 'quanta' ),
                    7 => esc_html__( '7 Columns', 'quanta' ),
                    8 => esc_html__( '8 Columns', 'quanta' ),
                    9 => esc_html__( '9 Columns', 'quanta' ),
                    10 => esc_html__( '10 Columns', 'quanta' ),
                    11 => esc_html__( '10 Columns', 'quanta' ),
                    12 => esc_html__( '12 Columns', 'quanta' ),
                ],
                'separator' => 'before',
                'default' => '3',
                'style_transfer' => true,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Desktop', 'quanta' ),
                'description' => esc_html__( 'Screen width equal to or greater than 1200px', 'quanta' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'quanta' ),
                    2 => esc_html__( '2 Columns', 'quanta' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Mobile', 'quanta' ),
                'description' => esc_html__( 'Screen width less than 767', 'quanta' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'quanta' ),
                    2 => esc_html__( '2 Columns', 'quanta' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Extra Small Mobile', 'quanta' ),
                'description' => esc_html__( 'Screen width less than 575px', 'quanta' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'quanta' ),
                    2 => esc_html__( '2 Columns', 'quanta' ),
                                     ...
                                     <li>
                                        <div class="course__lesson-3">
                                           <a href="#">
                                              ...
                                              <?php echo $tutor_lesson_count; ?> <?php echo esc_html__('videos','quanta'); ?> 
                                           </a>
                                        </div>
                                     </li>
                                     <?php endif; ?>
                                           ...
                                           <a href="#">
                                              <span>
                                               ...
                                               <?php
                                                ...
                                                ?> 
                                                <?php echo esc_html__('Reviews','quanta'); ?>
                                           </a>
                                        </div>
                                     </li>
                                     <?php endif; ?>
                                ...
                                <?php if ('yes' === $settings['tp_author_show']): ?>
                                 ...
                                 <div class="course__lesson">
                                    <a href="<?php print get_the_permalink() ?>"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       ...
                                       <?php echo $tutor_lesson_count; ?> <?php print esc_html__('lessons', 'quanta'); ?>
                                    </a>
                                 </div>
                                 <?php endif; ?>
                              </div>

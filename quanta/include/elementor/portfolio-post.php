...
class TP_Portfolio_Post extends Widget_Base {
	...
	public function get_title() {
		return __( 'Portfolio Post', 'quanta' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'tp_portfolio_query',
            [
                'label' => esc_html__('Portfolio Query', 'quanta'),
            ]
        );
        ...
        $this->start_controls_section(
            'tp_portfolio',
            [
                'label' => esc_html__('Portfolio - Layout', 'quanta'),
            ]
        );
        $this->add_control(
            'tp_design_style',
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Default', 'quanta'),
                    'layout-2' => esc_html__('Carousel', 'quanta'),
                    'layout-3' => esc_html__('Carousel Full Width', 'quanta'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'View More Item Button', 'quanta' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'quanta' ),
                'label_off' => esc_html__( 'Hide', 'quanta' ),
                'return_value' => 'yes',
        ...
        $this->start_controls_section(
            'tp_portfolio_columns_section',
            [
                'label' => esc_html__('Portfolio - Columns', 'quanta'),
            ]
        );
		...
		$this->start_controls_section(
            'tp_portfolio_slider_columns_section',
            [
                'label' => esc_html__('Portfolio - Columns for Carousel', 'quanta'),
            ]
        );
                        ...
                        <div class="mb-60">
                            <div class="tp-prjects-tab-menu masonary-menu d-flex justify-content-center">
                                <?php foreach ( $filter_list as $list ): ?>
                                    <?php if ( $i === 1 ): $i++; ?>
                                    <button class="active" data-filter="*"><?php echo esc_html__( 'See All','quanta' ); ?></button>

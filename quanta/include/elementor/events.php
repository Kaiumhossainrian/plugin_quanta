...
class TP_Events extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'tp_post_query',
            [
                'label' => esc_html__('Events Query', 'quanta'),
            ]
        );
        ...
        $this->start_controls_section(
            'tp_post_',
            [
                'label' => esc_html__('Event - Layout', 'quanta'),
            ]
        );
        $this->add_control(
            'tp_design_style',
                    ...
                    <div class="event__item white-bg mb-10 transition-3 p-relative d-lg-flex align-items-center justify-content-between">
                        ...
                        <div class="event__right d-sm-flex align-items-center">
                           ...
                           <div class="event__more ml-30">
                              <a href="<?php echo get_the_permalink(); ?>" class="tp-btn-5 tp-btn-7"><?php echo esc_html__('View Events','quanta'); ?></a>
                           </div>
                        </div>
                    </div>
              </div>

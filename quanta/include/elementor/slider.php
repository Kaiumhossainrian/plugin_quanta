...
class TP_Main_Slider extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'tp_main_slider',
            [
                'label' => esc_html__('Main Slider', 'quanta'),
        ...
        $repeater = new \Elementor\Repeater();
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'placeholder' => esc_html__('Type Before Heading Text', 'quanta'),
                    'label_block' => true,
                ]
            );
            $repeater->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__('Grow business.', 'quanta'),
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => esc_html__('There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration.', 'quanta'),
			...
			$repeater->add_control(
	            ...
	            [
	                'label' => esc_html__( 'Add Button link', 'quanta' ),
	        ...
	        $repeater->add_control(
	            'tp_btn_link',
	            [
	                'label' => esc_html__( 'Button Link link', 'quanta' ),
	        ...
	        $repeater->add_control(
	            'tp_btn_page_link',
	            [
	                'label' => esc_html__( 'Select Button Link Page', 'quanta' ),
        ...
        $this->add_control(
            'slider_list',
            [
                'label' => esc_html__('Slider List', 'quanta'),
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tp_slider_title' => esc_html__('Grow business.', 'quanta')
                    ],
                    [
                        'tp_slider_title' => esc_html__('Development.', 'quanta')
                    ],
                    [
                        'tp_slider_title' => esc_html__('Marketing.', 'quanta')
                    ],
                ],
                                 ...
                                 <div class="slider__search mb-20" data-animation="fadeInUp" data-delay=".9s">
                                    <form action="<?php print eduker_header_search_url();?>">
                                       <div class="slider__search-input p-relative">
                                       	  <input type="search" name="s" value="<?php print esc_attr( get_search_query() )?>" placeholder="<?php echo esc_attr__('Course title here...','quanta'); ?>">
